...
| SORTING_KEY                                          | Set tag to be used for sorting the stream list. `provider-order` keeps each provider's own channel order (earlier M3U index first)                                                                                | title                                                         | tvg-id, tvg-chno, tvg-group, tvg-type, source, provider-order                                                                                                                                                                                         |
